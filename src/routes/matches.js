...
matchRouter.post("/", async (req, res) => {
  // validate body using createMatchSchema
  // safeParse : not throwing error but returning an object with success and error details { success: true, data } / { success: false, error }
